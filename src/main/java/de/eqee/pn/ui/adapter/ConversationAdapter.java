...
import de.eqee.pn.ui.PnOverviewFragment;
import de.eqee.pn.ui.XmppActivity;
import de.eqee.pn.ui.util.Color;
import de.eqee.pn.ui.widget.UnreadCountCustomView;
...
public class ConversationAdapter extends RecyclerView.Adapter<ConversationAdapter.ConversationViewHolder> {
	...
	private List<Conversation> pn;
	private OnConversationClickListener listener;

	public ConversationAdapter(XmppActivity activity, List<Conversation> pn) {
	...
	public void onBindViewHolder(@NonNull ConversationViewHolder viewHolder, int position) {
		Conversation conversation = pn.get(position);
