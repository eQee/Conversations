...
import de.eqee.pn.ui.util.LocationHelper;
import de.eqee.pn.ui.widget.Marker;
import de.eqee.pn.ui.widget.MyLocation;
...
public abstract class LocationActivity extends ActionBarActivity implements LocationListener {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		this.marker_icon = BitmapFactory.decodeResource(ctx.getResources(), R.attr.location_marker_icon);
