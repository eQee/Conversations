...
public class ShareWithActivity extends XmppActivity implements XmppConnectionService.OnConversationUpdate {
	...
	private List<Conversation> mPn = new ArrayList<>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new ConversationAdapter(this, this.mPn);
	...
	public void onStart() {
		...
		if (xmppConnectionServiceBound) {
			if (share.uuid != null) {
				...
				xmppConnectionService.populateWithOrderedPn(mPn, this.share.uris.size() == 0);
			}
		}
	...
	public void refreshUiReal() {
		xmppConnectionService.populateWithOrderedPn(mPn, this.share != null && this.share.uris.size() == 0);
