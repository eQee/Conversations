...
import de.eqee.pn.databinding.ContactKeyBinding;
...
public abstract class OmemoActivity extends XmppActivity {
	...
	protected void addFingerprintRowWithListeners(LinearLayout keys, final Account account,
		...
		if (status.isActive()) {
			binding.key.setTextAppearance(this,R.style.TextAppearance_Pn_Fingerprint);
			binding.keyType.setTextAppearance(this,R.style.TextAppearance_Pn_Caption);
			...
			binding.key.setTextAppearance(this,R.style.TextAppearance_Pn_Fingerprint_Disabled);
			binding.keyType.setTextAppearance(this,R.style.TextAppearance_Pn_Caption_Disabled);
		...
		if (highlight) {
			binding.keyType.setTextAppearance(this,R.style.TextAppearance_Pn_Caption_Highlight);
